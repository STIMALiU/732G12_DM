...
\section*{Del 4: Email Spam}
    \begin{enumerate}
        \item Ladda in \texttt{spambase.csv} datasetet och bekanta dig med det (se bilaga för mer info). Vi vill skapa en modell som predikterar \texttt{spam} (0 eller 1) givet de förklarande variablerna. Då våra förklarande variabler är tungsvansade kan en log-transformation fungera bra ($\log(x + 0.1)$) där vi lägger på $0.1$ för att undvika $\log(0)$ problem.
