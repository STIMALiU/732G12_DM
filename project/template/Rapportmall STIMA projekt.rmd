...
- Visa metadata: dimensioner på data 
...
- Tex inom klassificering /regression: Om ni tänker använda någon icke-linjär metod, då är det ofta rimligt att jämföra med linjär regression/linjär logistisk regression (men även andra modeller kan vara intressant att jämföra med). Tänk frågan: "Vad vinner vi med en mer komplicerad modell?"
...
- Ta inte med någon tabell eller diagram som ni inte kommenterar eller tolkar.
