...
# Data
Detta kapitel beskriver den datamängd som rapporten baserar sig på. Definitioner av variabler och rapportspecifika termer som används, vilken källa de kommer ifrån osv.
...
# Metod (VIKTIGT!!!)
Detta kapitel beskriver de statistiska metoderna som används i rapporten. Hänvisa till litteraturen då metoderna förklaras och visa formler, t.ex. hur support beräknas.
...
Förklara vilka mjukvaror/progam/paket som ni använder för att tillämpa er metod.
...
Varje diagram och tabell som presenteras i rapporten ska vara numrerat och namngivet.

- Ta inte med någon tabell eller diagam som ni inte kommenterar eller tolkar.
...
Slutligen ska ni även ha en bilaga. Här kan bifoga diagram eller tabeller som tolkas i rapporten men inte anses vara alltför viktiga. 
Beräkningar av alla resultat bör framförallt visas i bilagan då det tar väldigt stor plats men alla tolkningar och analyser bör finnas med i brödtexten. 
